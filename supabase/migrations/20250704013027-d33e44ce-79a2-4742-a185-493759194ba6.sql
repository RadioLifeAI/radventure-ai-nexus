-- Corrigir função submit_daily_challenge para usar 'was_correct' em vez de 'is_correct'
DROP FUNCTION IF EXISTS public.submit_daily_challenge(uuid, uuid, boolean);

-- Função para submeter resposta do desafio diário (CORRIGIDA)
...
BEGIN
  ...
  -- Registrar resposta (CORRIGIDO: usando was_correct)
