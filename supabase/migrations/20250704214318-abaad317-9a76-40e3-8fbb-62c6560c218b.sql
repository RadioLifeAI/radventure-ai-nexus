-- CORREÇÃO: Fix constraint order e melhoria na função start_event_participation
-- Corrigir a função para usar a ordem correta da constraint (event_id, user_id)
...
BEGIN
  ...
  -- CORREÇÃO: Usar ordem correta da constraint (event_id, user_id)
