-- CORREÇÃO: Dropar funções existentes e recriar
DROP FUNCTION IF EXISTS public.start_event_participation(uuid);
DROP FUNCTION IF EXISTS public.update_event_progress(uuid, boolean, integer, integer);

-- Recriar função start_event_participation
...
-- Recriar função update_event_progress
