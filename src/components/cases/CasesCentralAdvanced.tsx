...
export function CasesCentralAdvanced() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden flex flex-col bg-gradient-to-br from-gray-100 via-slate-100 to-blue-100 text-gray-900">
      <HeaderNav />
      ...
      <main className="flex-1 w-full px-2 sm:px-4 lg:px-8 xl:px-16 py-4 sm:py-8 overflow-x-hidden">
        <div className="w-full space-y-4 sm:space-y-8">
          ...
          <div className="text-center px-2">
            {filters.specialty && (
              <div className="mb-4 flex flex-col sm:flex-row items-center justify-center gap-2">
                <Button
                  ...
                  className="text-blue-700 hover:text-blue-900 hover:bg-blue-50 border border-blue-300 bg-white shadow-md"
                >
                  <ArrowLeft className="h-4 w-4 mr-1" />
                  Voltar ao Dashboard
                </Button>
                <div className="bg-blue-100 rounded-full px-4 py-2 border border-blue-300 shadow-md">
            ...
            <p className="text-gray-800 text-sm sm:text-xl max-w-3xl mx-auto mb-4 sm:mb-6">
              Experiência de aprendizado revolucionária com IA, gamificação e visualizações inteligentes
            </p>
            <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
              <div className="flex items-center gap-2 bg-white rounded-full px-3 py-1 sm:px-4 sm:py-2 border border-gray-300 shadow-md">
                <Sparkles className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-600" />
                <span className="text-xs sm:text-sm text-gray-900 font-medium">Powered by AI</span>
              </div>
              <div className="flex items-center gap-2 bg-white rounded-full px-3 py-1 sm:px-4 sm:py-2 border border-gray-300 shadow-md">
                <Zap className="h-3 w-3 sm:h-4 sm:w-4 text-orange-600" />
                <span className="text-xs sm:text-sm text-gray-900 font-medium">Real-time Analytics</span>
              </div>
              <div className="flex items-center gap-2 bg-white rounded-full px-3 py-1 sm:px-4 sm:py-2 border border-gray-300 shadow-md">
                <Target className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                <span className="text-xs sm:text-sm text-gray-900 font-medium">Adaptive Learning</span>
              </div>
            </div>
          </div>

          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full space-y-4 sm:space-y-6">
            <TabsList className="grid w-full grid-cols-3 bg-white/95 backdrop-blur-md border border-gray-300 h-auto shadow-lg">
              <TabsTrigger value="advanced-dashboard" className="data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-md text-gray-700 text-xs sm:text-sm p-2 sm:p-3 font-medium">
                <BarChart3 className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" />
                <span className="hidden sm:inline">Dashboard Avançado</span>
                <span className="sm:hidden">Dashboard</span>
              </TabsTrigger>
              <TabsTrigger value="explorer" className="data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-md text-gray-700 text-xs sm:text-sm p-2 sm:p-3 font-medium">
              ...
              <TabsTrigger value="ai-journey" className="data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-md text-gray-700 text-xs sm:text-sm p-2 sm:p-3 font-medium">
              ...
              <Card className="bg-white border-gray-300 shadow-lg">
                ...
                <CardContent>
                  <div className="text-center py-4 sm:py-8">
                    ...
                    <Button 
                      className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white w-full sm:w-auto shadow-md"
