...
export function JourneyList({ onStartJourney, onEditJourney }: JourneyListProps) {
  ...
  // Helper function para tratar objectives como array
  const getObjectivesArray = (objectives: any): string[] => {
    if (Array.isArray(objectives)) {
      return objectives.filter(obj => typeof obj === 'string');
    }
    return [];
  };
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {journeys.map((journey) => {
          const objectivesArray = getObjectivesArray(journey.objectives);
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-4 text-xs text-gray-500">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {objectivesArray.length} objetivos
                  </div>
                </div>
