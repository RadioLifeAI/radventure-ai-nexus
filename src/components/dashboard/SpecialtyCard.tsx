...
export function SpecialtyCard({ specialty }: SpecialtyCardProps) {
  ...
  const handleExplore = () => {
    // Navegar para o primeiro caso da especialidade com filtros aplicados
    navigate(`/app/casos?specialty=${encodeURIComponent(specialty.name)}&autoStart=true`);
  };
    ...
    >
      ...
      <div className="relative p-6 flex flex-col h-full min-h-[180px]">
        ...
        <div className="mt-auto flex items-center justify-between">
          ...
          >
            <span className="mr-2">
              {hasProgress ? 'Continuar' : 'Explorar'}
            </span>
