...
export function CaseCard({ case: caseData }: CaseCardProps) {
  ...
  return (
    <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-[1.02] bg-white/95 backdrop-blur-sm border-gray-300/60 shadow-lg">
      ...
      <CardContent className="pt-0">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4 text-sm text-gray-700">
            <div className="flex items-center gap-1">
              ...
              <span className="font-semibold text-gray-900">{caseData.points} pts</span>
            </div>
            <div className="flex items-center gap-1">
        ...
        <Button 
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-semibold py-2 px-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-white/20"
        >
