...
export default function EventosEnhanced() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-100 via-blue-100 to-cyan-100">
      <HeaderNav />
      <main className="flex-1 flex flex-col px-2 md:px-16 pt-4 pb-10">
        {/* Header revolucionário */}
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="font-extrabold text-4xl mb-2 text-gray-900 animate-fade-in bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
              Eventos Gamificados 🚀
            </h1>
          ...
          <div className="flex items-center gap-3">
            ...
            {user && (
              <Button 
                className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 border border-white/20 shadow-md"
            ...
            {!user && (
              <Button 
                variant="outline"
                className="text-gray-800 border-gray-300 bg-white/80 hover:bg-white hover:text-blue-700 shadow-md"
        ...
        <div className="mt-6">
          <Tabs value={activeView} onValueChange={setActiveView} className="space-y-6">
            <TabsList className="grid grid-cols-2 md:grid-cols-5 bg-white/90 backdrop-blur-sm border border-gray-300/60 shadow-md">
              <TabsTrigger value="dashboard" className="data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-md data-[state=active]:border-b-2 data-[state=active]:border-cyan-500 text-gray-700">
                <BarChart3 className="h-4 w-4 mr-2" />
                <span className="hidden sm:inline">Dashboard</span>
              </TabsTrigger>
              <TabsTrigger value="visualization" className="data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-md data-[state=active]:border-b-2 data-[state=active]:border-cyan-500 text-gray-700">
                <TrendingUp className="h-4 w-4 mr-2" />
                <span className="hidden sm:inline">Visualizações</span>
              </TabsTrigger>
              <TabsTrigger value="gamification" className="data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-md data-[state=active]:border-b-2 data-[state=active]:border-cyan-500 text-gray-700">
                <Trophy className="h-4 w-4 mr-2" />
                <span className="hidden sm:inline">Gamificação</span>
              </TabsTrigger>
              <TabsTrigger value="events" className="data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-md data-[state=active]:border-b-2 data-[state=active]:border-cyan-500 text-gray-700">
                <Calendar className="h-4 w-4 mr-2" />
                <span className="hidden sm:inline">Todos</span>
              </TabsTrigger>
              <TabsTrigger value="analytics" className="data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-md data-[state=active]:border-b-2 data-[state=active]:border-cyan-500 text-gray-700">
            ...
            <TabsContent value="events">
              <div className="space-y-6">
                ...
                {loading ? (
                  <div className="text-gray-700 mt-6 animate-fade-in">Carregando eventos...</div>
                ) : (
                ...
                <CardContent>
                  <div className="space-y-6">
                          ...
                          {['Participação', 'Pontuação Média', 'Novos Usuários'].map((metric, index) => (
                            <div key={metric} className="flex items-center justify-between">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-green-600 text-sm font-medium">+{(index + 1) * 5}%</span>
                              </div>
                            </div>
                          ))}
                        </div>
                    ...
                    {user ? (
                      <div className="bg-gray-50/80 rounded-lg p-4 border border-gray-200/60">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div className="text-center">
                            <div className="text-2xl font-bold text-cyan-600">{metrics.userRegistrations}</div>
                            <div className="text-sm text-gray-700">Eventos Inscritos</div>
                          </div>
                          <div className="text-center">
                            <div className="text-2xl font-bold text-green-600">{metrics.userCompletedEvents}</div>
                      ...
                      <div className="bg-gray-50/80 rounded-lg p-4 text-center border border-gray-200/60">
                        <h4 className="font-medium text-gray-900 mb-3">Faça Login para Ver Suas Estatísticas</h4>
                        <Button onClick={() => navigate("/login")} className="bg-cyan-600 hover:bg-cyan-700 border border-white/20">
                          Fazer Login
                        </Button>
                      </div>
                    )}
